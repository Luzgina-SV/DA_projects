...
|---|---------------|--------------------------|----------|
|1.| Exploratory data analysis - apartment sales data analysis [Apart_sales_research](https://github.com/Luzgina-SV/DA_projects/blob/main/Apart_sales_research/DA_project_Apart_sales_research.ipynb)| Analyze the key characteristics of apartments for sale, apartment pricing and sales period analysis| Python: pandas, numpy, matplotlib, seaborn|
|2.| Comprehensive data analysis of online store consumer data [E_Com](https://github.com/Luzgina-SV/DA_projects/blob/main/E_Com/DA_ECom.ipynb)| Detection of typical consumption patterns, profiling consumers by segments, identifying key-problem points and potential areas for growth | Python: pandas, numpy, datetime, scipy, matplotlib, seaborn, plotly|
|3.| Exploratory and Statistical data analysis [Widgets](https://github.com/Luzgina-SV/DA_projects/blob/main/Wigdets/reviewlab_widget.ipynb)| Preprocessing data and performing exploratory data analysis on the prepared data about the Kazakhstan car market and the position of one of the car dealerships in it | Python: pandas, numpy, re, scipy, datetime, matplotlib, seaborn|


|4.| Statistical data analysis -  scooter rental data analysis [Oil](https://github.com/Luzgina-SV/DA_projects/blob/main/oil/ML_project_oil_well_location_clean.ipynb)| Exploring data about users, their trips and the rates of the scooter rental service, as well as testing hypotheses to support the development of the scooter rental business.| Python: pandas, numpy, scipy, math, matplotlib, seaborn|
